 ...
 */
var handleErrors = function (_, req, res) {
    // const ctx = req.state
    res
        .status(500)
...
var attachMetadata = function (req) {
    var state = {
        trackingId: utils_js_1.trackingId(),
        ip: utils_js_1.hash(req.headers['x-real-ip']),
        forwardedFor: utils_js_1.hash(req.headers['x-forwarded-for']),
 ...
 */
exports.routeMethod = function (methods) { return function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
