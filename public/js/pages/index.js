 ...
 * http://polymer.github.io/PATENTS.txt
 */
  class _ {constructor (e, t, n) { this.__parts = [], this.template = e, this.processor = t, this.options = n }update (e) { let t = 0; for (const n of this.__parts) void 0 !== n && n.setValue(e[t]), t++; for (const e of this.__parts) void 0 !== e && e.commit() }_clone () { const e = o ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0); const t = []; const n = this.template.parts; const s = document.createTreeWalker(e, 133, null, !1); let i; let r = 0; let a = 0; let l = s.nextNode(); for (;r < n.length;) if (i = n[r], v(i)) { for (;a < i.index;)a++, l.nodeName === 'TEMPLATE' && (t.push(l), s.currentNode = l.content), (l = s.nextNode()) === null && (s.currentNode = t.pop(), l = s.nextNode()); if (i.type === 'node') { const e = this.processor.handleTextExpression(this.options); e.insertAfterNode(l.previousSibling), this.__parts.push(e) } else this.__parts.push(...this.processor.handleAttributeExpressions(l, i.name, i.strings, this.options)); r++ } else this.__parts.push(void 0), r++; return o && (document.adoptNode(e), customElements.upgrade(e)), e }}
  /**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y = ` ${c} `; class x {constructor (e, t, n, s) { this.strings = e, this.values = t, this.type = n, this.processor = s }getHTML () { const e = this.strings.length - 1; let t = ''; let n = !1; for (let s = 0; s < e; s++) { const e = this.strings[s]; const i = e.lastIndexOf('\x3c!--'); n = (i > -1 || n) && e.indexOf('--\x3e', i + 1) === -1; const o = f.exec(e); t += o === null ? e + (n ? y : d) : e.substr(0, o.index) + o[1] + o[2] + h + o[3] + c } return t += this.strings[e] }getTemplateElement () { const e = document.createElement('template'); return e.innerHTML = this.getHTML(), e }}
  /**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
},, function (e, t, n) { 'use strict'; n.r(t); var s = n(0); const i = e => { const t = { atrocious: 0, 'in pain': 1, ennui: 2, bad: 3, neutral: 4, decent: 5, fine: 6, stellar: 7 }; return t.hasOwnProperty(e.toLowerCase()) ? t[e] : t.neutral }; const o = (e, t) => { const n = { value: null, metric: -1 / 0 }; for (const s of e) { const e = t(s); e > n.metric && (n.value = s, n.metric = e) } return n.value }; const r = [{ date: new Date(1e11), mood: 'bad' }, { date: new Date(2e11), mood: 'bad' }, { date: new Date(3e11), mood: 'decent' }, { date: new Date(4e11), mood: 'stellar' }, { date: new Date(45e11), mood: 'stellar' }]; const a = (e, t) => { const n = (e => { const t = o(e, e => e.date.getTime()); const n = ((e, t) => { const n = { value: null, metric: 1 / 0 }; for (const s of e) { const e = t(s); e < n.metric && (n.value = s, n.metric = e) } return n.value })(e, e => e.date.getTime()); return { to: t ? t.date : null, from: n ? n.date : null } })(r); const s = ((e, t) => e.map(e => ({ ...e, offset: e.date.getTime() - t.from.getTime() })))(r, n); const { offset: a } = o(s, e => e.offset); s.map(e => ({ x: e.offset / a, y: i(e.mood) })) }; a(); var l = n(1); var c = { google: { clientId: '1053339394516-8m3pa0tvsejqha2usv84rkul7ja804s6.apps.googleusercontent.com' }, keys: { googleToken: 'GOOGLE_ID_TOKEN', cachedEvents: 'cached-events' } }; const d = () => { const e = l.a.get(c.keys.cachedEvents); e == null && l.a.set(c.keys.cachedEvents, []) }; const u = { addEvent: e => { d(); const t = l.a.get(c.keys.cachedEvents); t.push(e), l.a.set(c.keys.cachedEvents, t) }, retrieveEvents: () => { return d(), l.a.get(c.keys.cachedEvents) }, removeEvents: e => { d(); const t = u.retrieveEvents(); const n = new Set(e.map(e => e.id)); const s = t.filter(e => !n.has(e.id)); l.a.set(c.keys.cachedEvents, s) } }; var h = u; const p = { moods: {} }; const m = e => JSON.stringify(e, null, 2); const v = e => { const t = l.a.get(c.keys.googleToken); if (t) return e(t); throw new Error('token was absent, so could not log in') }; p.moods.post = async () => { console.log('⛏ syncing events to server'); const e = h.retrieveEvents(); v(t => fetch('api/moods', { method: 'PATCH', headers: { Authorization: `Bearer ${t}` }, body: m({ events: e }) })); h.removeEvents(e) }, p.moods.get = async () => v(e => fetch('api/moods', { method: 'GET', headers: { 'x-auth-token': `Bearer ${e}` }, qs: { from: from, to: to } })); var g = n(2); !(async function () { await Object(l.c)(), document.querySelectorAll('.mood-emotion').forEach(e => { e.onclick = async e => { const t = l.b.event(e.target); h.addEvent(t); try { await p.moods.post() } catch (e) { console.error(`failed to send events: ${e.message}`) } } }), a(null, {}) }()), Object(s.b)(g.a.index(), document.body) }]))
